...
public class ElasticsearchJdApplicationTests {
    ...
    @Test
    void detailindex() throws IOException {
        GetIndexRequest req = new GetIndexRequest("kuang_index");
    ...
    void testAddDocument() throws IOException {
        ...
        System.out.println(indexResponse.status()); // OK CREATED
        System.out.println(indexResponse.getResult()); // 对应我们命令返回的状态CREATED、UPDATED
    }
    ...
    @Test
    void searchtes() throws IOException {
