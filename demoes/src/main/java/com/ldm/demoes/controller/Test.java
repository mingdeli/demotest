...
public class Test {
     ...
     * zookeeper地址
     */
    static final String CONNECT_ADDR = "192.168.202.133:2181,192.168.202.134:2181,192.168.202.135:2181";
...
//        zk.create("/super/c2", "c2".getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
        //创建子节点
        zk.create("/super/c33", "c3".getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
        //创建子节点
...
//        zk.delete("/super/c3", -1);
        ...
        String tableSerial = "tableSerial";
...
//                    log.info("{}: 当前人数 = {} , 总人数 = {}, 人还不够: 吃饭不积极，一定有问题...", customerName, list.size(), tableCapacity);
//                    mutex.wait();
//                } else {
